...
//		testIllegal();
			...
			if(mouse.pressed == false) {
				...
				if ( activeP != null) {
					...
					if(validSquare) {
						...
						// Update the piece list in a case a piece has been captured and removed during
	...
	private void simulate() {
		...
		//This is basically for restoring the removed piece during the stimulation
		copyPieces(pieces, simPieces);
	...
	private boolean isCheckmate() {
		...
		if(KingCanMove(king)) {
			...
			// Check the positio of the checking piece and the king in check
	...
	public void paintComponent(Graphics g) {
		...
		if(promotion) {
			...
			if(currentColor == WHITE) {
				g2.drawString("White's turn ", 740, 540);
				if(checkingP != null && checkingP.color == BLACK) {
					g2.setColor(Color.red);
					g2.drawString("The King", 740, 640);
					g2.drawString("Is in check!", 740, 690);
				}
			}
			else {
				g2.drawString("Black's turn ", 740, 175);
				if(checkingP != null && checkingP.color == WHITE) {
					g2.setColor(Color.red);
					g2.drawString("The King", 740, 25);
					g2.drawString("Is in check!", 740, 75);
				}
			}
		}
		...
		if(gameover) {
			...
			g2.drawString(s, 100, 400);
		}
		if(stalemate) {
			g2.setFont(new Font("Arial", Font.PLAIN,100));
			g2.setColor(Color.lightGray);
			g2.drawString("Stalemate", 100, 400);
